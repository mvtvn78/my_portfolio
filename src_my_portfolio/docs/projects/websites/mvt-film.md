...
en:
  title: MvtFilm
  about: MvtFilm is a movie streaming web application mainly for animation and anime. Creates a simple website with an appealing and clean interface for users, and also creates an admin management page for administrators
  features:
    - Movie watching feature
    - Movie recommendation based on recently watched movies
    - Movie download & storage feature
    - User information editing and security feature
    - Manage website structural entities
    - Movie rating feature
    - Login & registration feature
    - Google login integration
    - Movie ranking by category feature
